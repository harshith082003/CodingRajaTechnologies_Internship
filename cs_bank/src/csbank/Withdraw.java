...
public class Withdraw extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Enter Withdraw Amount");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        try {
            ...
            if(Integer.parseInt(amount) > Integer.parseInt(accBalance) || Integer.parseInt(amount) < 0){
                JOptionPane.showMessageDialog(this,"Enter a valid Withdrawal amount");
                return;
            } else if(Integer.parseInt(accPin) != Integer.parseInt(pin)){
                JOptionPane.showMessageDialog(this,"Enter a valid PIN number");
                return;
            } else{
                insert = conn.prepareStatement("insert into withdraws(acc_id, cust_id, date, balance, withdraw) values(?,?,?,?,?)");
